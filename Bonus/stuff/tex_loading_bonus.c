...
/*   Updated: 2025/04/16 11:04:06 by achbira          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void load_texture(t_data *data, t_loaded_tex *tex, void *mlx, char *file)
{
    ...
    tex->img.pixs = (int *)mlx_get_data_addr(tex->img.img, 
    ...
    tex->img.addr = (char *)tex->img.pixs;
}
...
void load_all_textures(t_ready_tex *textures, void *mlx, t_data *data)
{
    ...
    load_texture(data, &data->sprites.texpm, mlx, "textures/fire/fire00.xpm");
}
